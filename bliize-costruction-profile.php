...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- Start header -->
        <?php
        $HeaderStyle = 'wpo-header-style-s14 bb-1';
        ?>
        <?php include './partials/header.php' ?>
        <!-- end of header -->

        <!--===== start wpo-hero-slider =====-->
        <section class="wpo-hero-static-s14">
            <div class="wraper">
                <div class="content">
                    <h2 class="fade_bottom">Designing
                        <span class="hero-slider-s12">
                            <span class="item">
                                <img src="assets/images/slider/slider-14/1.jpg" alt="">
                            </span>
                            <span class="item">
                                <img src="assets/images/slider/slider-14/2.jpg" alt="">
                            </span>
                        </span> the
                        Future, Today.
                    </h2>
                ...
                <div class="hero-right fade_bottom">
                    <img src="assets/images/slider/slide-14.jpg" alt="">
                </div>
            </div>
        </section>

        <!--===== start wpo-partners-section =====-->
        <section class="wpo-partners-section-s14">
            <h2 class="d-none">No Content</h2>
            <ul class="partners-slider fade_bottom">
                <li>
                    <div>
                        <img src="assets/images/partners/white/1.png" alt="">
                    </div>
                </li>
                <li>
                    <div>
                        <img src="assets/images/partners/white/2.png" alt="">
                    </div>
                </li>
                <li>
                    <div>
                        <img src="assets/images/partners/white/3.png" alt="">
                    </div>
                </li>
                <li>
                    <div>
                        <img src="assets/images/partners/white/4.png" alt="">
                    </div>
                </li>
                <li>
                    <div>
                        <img src="assets/images/partners/white/5.png" alt="">
                    </div>
                </li>
                <li>
                    <div>
        ...
        <section class="wpo-service-section-s14">
            <div class="service-left">
                <div class="title fade_bottom">
                    <h2>What I Do</h2>
            ...
            <div class="service-wrap">
                <div class="service-card-s14 fade_bottom">
                    <div class="item">
                        <div class="icon">
                            <img src="assets/images/service/icon-2/1.svg" alt="icon">
                        </div>
                        <div class="content">
                ...
                <div class="service-card-s14 fade_bottom">
                    <div class="item">
                        <div class="icon">
                            <img src="assets/images/service/icon-2/2.svg" alt="icon">
                        </div>
                        <div class="content">
                ...
                <div class="service-card-s14 fade_bottom">
                    <div class="item">
                        <div class="icon">
                            <img src="assets/images/service/icon-2/3.svg" alt="icon">
                        </div>
                        <div class="content">
                            <h2><a href="service-single.php">Custom Solutions</a></h2>
                            <p>Magnis lorem tinidunt eunamdictu mstlacus. Mattis risus vitae pretium viverra
                ...
                <div class="service-card-s14 fade_bottom">
                    <div class="item">
                        <div class="icon">
                            <img src="assets/images/service/icon-2/4.svg" alt="icon">
                        </div>
                        <div class="content">
        ...
        <section class="wpo-project-section-s14 section-padding pb-0">
            <div class="wraper">
                <div class="title">
                    <h2 class="poort-text poort-in-right">Lets See Our Featured Work</h2>
                    <p class="poort-text poort-in-right">Blaze is a trailblazing architecture agency renowned for its
                ...
                <div class="project-content">
                    <div class="item fade_bottom">
                        <div class="imgWrap">
                            <img src="assets/images/project/project-14/1.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="top">
                                <h3>01</h3>
                            ...
                            <div class="botom-content">
                                <h2><a href="project-single.php">Bed Room Decor</a></h2>
                    ...
                    <div class="item fade_bottom">
                        <div class="imgWrap">
                            <img src="assets/images/project/project-14/2.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="top">
                                <h3>02</h3>
                            ...
                            <div class="botom-content">
                                <h2><a href="project-single.php">Office Interior Design</a></h2>
                                <span>Building, Apartment</span>
                            </div>
                        </div>
                    </div>
                    <div class="item fade_bottom">
                        <div class="imgWrap">
                            <img src="assets/images/project/project-14/3.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="top">
                                <h3>03</h3>
                            ...
                            <div class="botom-content">
                                <h2><a href="project-single.php">Living Room Interior</a></h2>
                                <span>Building, Apartment</span>
                            </div>
                        </div>
                    </div>
                    <div class="item fade_bottom">
                        <div class="imgWrap">
                            <img src="assets/images/project/project-14/4.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="top">
                                <h3>04</h3>
        ...
        <section class="wpo-funfact-section-s14">
        ...
        <section class="wpo-faq-section">
            <div class="title">
                <div class="content">
                    <h2 class="poort-text poort-in-right">Frequently Asked
                        Questions</h2>
                    <p class="poort-text poort-in-right">If you don't have any questions, please let us know.</p>
            ...
            <div class="accordion-wrap" id="accordionExample">
                <div class="accordion-item fade_bottom">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            Blaze is a trailblazing architecture agency renowned for its innovative approach to design,
                            where creativity meets functionality. From futuristic skyscrapers to timeless cultural
                            landmarks, We specializes in crafting spaces that inspire and endure
                        </div>
                    </div>
                </div>
                <div class="accordion-item fade_bottom">
                ...
                <div class="accordion-item fade_bottom">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            Blaze is a trailblazing architecture agency renowned for its innovative approach to
                            design, where creativity meets functionality. From futuristic skyscrapers to timeless
                            cultural landmarks, We specializes in crafting spaces that inspire and endure
                        </div>
                    </div>
                </div>
                <div class="accordion-item fade_bottom">
        ...
        <section class="wpo-video-section section-padding">
            ...
            <div class="wraper" style="background: url(assets/images/wpo-video-bg-2.jpg);">
        ...
        <!--===== start wpo-consultaForm-section-s2 =====-->
        <section class="wpo-consultaForm-section-s2 section-padding pt-0">
            <div class="container">
