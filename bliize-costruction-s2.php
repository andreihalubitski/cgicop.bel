...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="wpo-hero-static-s11">
            <div class="wraper">
                <div class="content">
                    <h2 class="fade_bottom">Building The Future</h2>
                    ...
                    <a class="hero-btn fade_bottom" href="contact.php"><span>Explore Our Work</span> <i
                            class="ti-arrow-right"></i></a>
                    <div class="hero-team fade_bottom">
                        <ul>
                            <li><img src="assets/images/team/hero-team/1.jpg" alt="hero-team"></li>
                            <li><img src="assets/images/team/hero-team/2.jpg" alt="hero-team"></li>
                            <li><img src="assets/images/team/hero-team/3.jpg" alt="hero-team"></li>
                            <li><img src="assets/images/team/hero-team/4.jpg" alt="hero-team"></li>
                        </ul>
                        <span>Meet Our Team</span>
                    </div>
                </div>
                <div class="hero-right fade_bottom">
                    <div class="hero-slider-s12">
                        <div class="item">
                            <img src="assets/images/slider/slider-13/1.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="assets/images/slider/slider-13/2.jpg" alt="">
                        </div>
                    </div>
                ...
                <div class="testimonial fade_bottom">
                    <div class="icon">
        ...
        <section class="wpo-service-section-s13 section-padding">
        ...
        <section class="wpo-video-section-s3">
            ...
            <div class="wraper" style="background: url(assets/images/wpo-video-bg-4.jpg);">
        ...
        <section class="wpo-about-section-s13 section-padding">
            <div class="wraper">
                <div class="about-left fade_bottom">
                    <img src="assets/images/about/about-8/1.jpg" alt="">
                </div>
                <div class="about-mid">
                    <h2 class="fade_bottom">About Us</h2>
                    <h3 class="fade_bottom">An Award Winning Construction Company</h3>
                    <p class="fade_bottom">Blaze is a trailblazing architecture agency renowned for its innovative
                    ...
                    <div class="fanfuct">
                        <div class="row">
                            <div class="col-md-6 col-12 fade_bottom">
                                <div class="item">
                                    <h4><span class="odometer" data-count="215">00</span> <span class="icon">+</span>
                                    </h4>
                            ...
                            <div class="col-md-6 col-12 fade_bottom">
                                <div class="item">
                                    <h4><span class="odometer" data-count="550">00</span> <span class="icon">+</span>
                                    </h4>
                ...
                <div class="about-right fade_bottom">
                    ...
                    <div class="image">
                        <img src="assets/images/about/about-8/2.jpg" alt="">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="wpo-project-section-s13 section-padding">
            <div class="wraper">
                <div class="title">
        ...
        <section class="wpo-testimonial-section-s13 section-padding ">
            <div class="testimonial-wrap" style="background: url(assets/images/testimonial/testimonial-bg-3.jpg);">
                <div class="testimonial-slider-s4 owl-carousel">
                    <div class="item">
                        <div class="content fade_bottom">
                            <div class="icon">
                                <img src="assets/images/testimonial/quote-2.svg" alt="quote">
                            </div>
                            <h3>Purus eget conctur massa amet. Hac diam suspendisse faucibus posuere dignim magna
                                conum
                                tristique.
                            </h3>
            ...
            <div class="image-right">
                <img src="assets/images/testimonial/img-6.png" alt="">
            </div>
        </section>


        <!--===== start wpo-blog-section =====-->
        <section class="wpo-blog-section-s13 section-padding">
            <div class="container-fluid">
                ...
                <div class="blog-wrap">
                    <div class="row">
                        <div class="col col-lg-6 col-md-6  col-12 fade_bottom">
                        ...
                        <div class="col col-lg-6 col-md-6  col-12 fade_bottom">
                            <div class="blog-card-s12">
                                <div class="image">
                                    <img src="assets/images/blog/blog-12/4.jpg" alt="blog">
                                </div>
                                <div class="text">
