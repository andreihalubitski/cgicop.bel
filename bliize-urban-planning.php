...
<body>
    ...
    <div class="page-wrapper">
        ...
        <header id="header">
            <?php
            $HeaderStyle = 'wpo-header-style-s10';
            ?>
        ...
        <section class="wpo-hero-static-s9" style="background: url(assets/images/slider/slide-bg-11.jpg);">
            <div class="content">
                <h2 class="fade_bottom"><span>Where Vision Meets</span> <br>
                    Urban Excellence</h2>
                ...
                <div class="hero-btn fade_bottom">
                    <a href="projects.php" class="shop-btn">Explore Our Work</a>
                </div>
            </div>
            <div class="hero-right">
                <img src="assets/images/slider/slide-11.jpg" alt="">
            </div>
        </section>
        ...
        <section class="wpo-service-section-s9 section-padding">
            <div class="container-fluid p-0">
                <div class="title">
                    <h2 class="poort-text poort-in-right">Our Services For You</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-12 fade_bottom">
                            <div class="service-card">
                                ...
                                <h2><a href="service-single.php">Urban Design</a></h2>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 fade_bottom">
                            <div class="service-card">
                                ...
                                <h2><a href="service-single.php">Environmental Planning</a></h2>
                                <p>Magnis lorem tinidunt eunamdictu mstlacus. Mattis risus vitae pretium viverra libero
                                    dapibus.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-12 fade_bottom">
                            <div class="service-card">
                                ...
                                <h2><a href="service-single.php">Community Engagement</a></h2>
                                <p>Magnis lorem tinidunt eunamdictu mstlacus. Mattis risus vitae pretium viverra libero
                                    dapibus.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-12 fade_bottom">
                            <div class="service-card">
                                ...
                                <h2><a href="service-single.php">Master Planning</a></h2>
                                <p>Magnis lorem tinidunt eunamdictu mstlacus. Mattis risus vitae pretium viverra libero
                                    dapibus.</p>
                            </div>
                        </div>
        ...
        <section class="wpo-video-section-s2">
            ...
            <div class="wraper" style="background: url(assets/images/wpo-video-bg-3.jpg);">
        ...
        <section class="wpo-project-section-s10 section-padding">
            <div class="container-fulid p-0">
                <div class="title">
                    <h2 class="poort-text poort-in-right">Our Feature Projects</h2>
                    <p class="poort-text poort-in-right">Leveraging advanced tools and techniques, Blaze ensures
                        precision and efficiency.
                    </p>
                </div>
                <div class="project-slider-s7">
                    <!-- Slides -->
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="item">
                                <div class="imgWrap">
                                    <img src="assets/images/project/project-10/1.jpg" alt="" class="x1">
                                    <img src="assets/images/project/project-10/1.jpg" alt="" class="x2">
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <div class="item">
                                <div class="imgWrap">
                                    <img src="assets/images/project/project-10/2.jpg" alt="" class="x1">
                                    <img src="assets/images/project/project-10/2.jpg" alt="" class="x2">
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <div class="item">
                                <div class="imgWrap">
                                    <img src="assets/images/project/project-10/3.jpg" alt="" class="x1">
                                    <img src="assets/images/project/project-10/3.jpg" alt="" class="x2">
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <div class="item">
                                <div class="imgWrap">
                                    <img src="assets/images/project/project-10/4.jpg" alt="" class="x1">
                                    <img src="assets/images/project/project-10/4.jpg" alt="" class="x2">
                                </div>
                                <div class="content">
                                    <h2><a href="project-single.php">Office Interior Design</a></h2>
                                    <span>Building, Apartment</span>
                        ...
                        <div class="swiper-slide">
                            <div class="item">
                                ...
                                <div class="content">
                                    <h2><a href="project-single.php">Office Design</a></h2>
                                    <span>Building, Apartment</span>
                                </div>
                            </div>
                        </div>
        ...
        <section class="wpo-funfact-section-s11">
        ...
        <section class="wpo-consultaForm-section">
            <div class="wraper" style="background: url(assets/images/contact-bg.jpg);">
                <div class="contact">
